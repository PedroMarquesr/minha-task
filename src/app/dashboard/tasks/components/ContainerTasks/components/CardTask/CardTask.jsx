...
//       position="relative"
//       overflowX="clip"  // ← "clip" contém o transform sem afetar o layout do pai (diferente de "hidden")
//       _hover={{
//         boxShadow: "md",
//         transform: "translateY(-2px)",  // ← mantida a animação
...
//     >
//       <Flex justifyContent="space-between" alignItems="flex-start" mb={description ? 3 : 1} gap={4}>
...
//         <Flex align="center" position="relative" zIndex={2} flexShrink={0}>
...
//       <Box mt={4} mb={3} borderTop="1px solid" borderColor="gray.100" _dark={{ borderColor: "whiteAlpha.200" }} />
...
//             <Text
//               fontWeight="medium"
//               color={new Date(dueDate) < new Date() && !isCompleted ? "red.500" : "inherit"}
//               _dark={{ color: new Date(dueDate) < new Date() && !isCompleted ? "red.400" : "inherit" }}
//             >
//               Prazo:{" "}
//               {dueDate?.toDate
